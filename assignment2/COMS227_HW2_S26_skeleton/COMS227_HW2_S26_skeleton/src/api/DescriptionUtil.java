...
public class DescriptionUtil {
	/**
	 * Reads a the given file and creates a list of 2D string arrays from each boulder 
	 ...
	 * descriptions that indicate the cell type or the presence of a boulder in a
	 * cell. Despite the name of this method, it does NO checking for whether a
	 * given boulder of text actually represents a valid board position for the game.
